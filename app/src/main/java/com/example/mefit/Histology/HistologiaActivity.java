package com.example.mefit.Histology;
...
public class HistologiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_histologia);
        ...
        BASE_DE_DATOS= FirebaseDatabase.getInstance().getReference("RECURCES_APP/QUIZHISTOLOGIA");
